<footer class="bg-gradient-to-br from-[#A0522D] to-stone-900 text-misty-rose py-16 border-t-[16px] border-sakura">
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">

        <div>
            <div class="flex items-center gap-2 font-bold text-2xl mb-6">
                <img src="{{ asset('images/Logo-CosRent.png') }}" alt="CosRent Logo" class="h-10 w-auto">
                CosRent
            </div>
            ...
            <div class="flex gap-4">
                ...
                <a href="https://www.youtube.com/@CosRentOfficial" class="w-10 h-10 rounded-full border border-misty-rose/30 flex items-center justify-center hover:bg-sakura hover:text-stone-900 transition" aria-label="YouTube">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fill-rule="evenodd" d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.746 22 12 22 12s0 3.255-.418 4.814a2.504 2.504 0 0 1-1.768 1.768c-1.56.419-7.814.419-7.814.419s-6.255 0-7.814-.419a2.505 2.505 0 0 1-1.768-1.768C2 15.255 2 12 2 12s0-3.255.417-4.814a2.507 2.507 0 0 1 1.768-1.768C5.744 5 11.998 5 11.998 5s6.255 0 7.814.418ZM15.194 12 10 15V9l5.194 3Z" clip-rule="evenodd"/>
                    </svg>
                </a>
                <a href="https://www.polibatam.ac.id" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full border border-misty-rose/30 flex items-center justify-center hover:bg-sakura hover:text-stone-900 transition" aria-label="Polibatam">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 14v6m0-6V8"></path>
                    </svg>
                </a>
            </div>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-4 text-sm opacity-90">
                <li class="flex items-start gap-3">
                    ...
                    <span>Jalan Ahmad Yani Batam Kota, Kota Batam, Kepulauan Riau 29461</span>
                </li>
                <li class="flex items-center gap-3">
                    <span>📞</span>
                    <span>+62 896-2346-7477</span>
                </li>
                <li class="flex items-center gap-3">
                    <span>✉️</span>
                    <span>Cosrent@gmail.com</span>
                </li>
            </ul>
        </div>
