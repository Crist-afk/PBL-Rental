...
@section('title', 'Sewa Raiden Shogun - CosRent')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-8">
            ...
            <section class="glass-card rounded-[2.5rem] border-2 border-dark-chocolate/10 p-4 shadow-xl flex items-center justify-center">
                <div class="w-full h-[400px] md:h-[500px] bg-dark-chocolate/10 rounded-[2rem] flex flex-col items-center justify-center relative overflow-hidden group">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQAyRb2yyqRYDoVriPxVzLrslGO3PT0rJ6G1g&s" alt="Raiden Shogun" class="w-full h-full object-cover transition duration-500 group-hover:scale-105">
                    <div class="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300 pointer-events-none">
                        <span class="text-misty-rose font-bold"><i class="fa-solid fa-image mr-2"></i>Gambar Raiden Shogun</span>
                    </div>
                </div>
            </section>
            ...
            <section class="glass-card rounded-[2.5rem] border-2 border-dark-chocolate/10 p-6 md:p-8 shadow-xl flex flex-col">
                <span class="mb-2 block text-xs font-black uppercase tracking-[0.35em] text-aloewood">Genshin Impact</span>
                <h1 class="text-4xl md:text-5xl font-extrabold text-dark-chocolate mb-2">Raiden Shogun</h1>
                
                <div class="flex flex-wrap items-center gap-4 mb-6 pb-6 border-b border-dark-chocolate/10">
                    <span class="text-3xl font-black text-sakura">Rp 180.000 <span class="text-lg font-medium text-dark-chocolate/60">/ 3 Hari</span></span>
                ...
                <div class="space-y-4 mb-8 flex-grow">
                    ...
                    <p class="text-dark-chocolate/80 text-sm font-medium leading-relaxed">
                        Kostum cosplay Raiden Shogun dari Genshin Impact dengan detail premium. Set lengkap mencakup kimono ungu eksklusif, obi dengan vision Electro menyala (baterai termasuk), aksesori rambut, stoking, dan pelindung kaki. Kain yang digunakan berkualitas tinggi, halus, dan tidak panas saat dipakai event seharian.
                    </p>
                    ...
                    <ul class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm font-medium text-dark-chocolate/80">
                        <li class="flex items-center gap-2"><div class="w-5 h-5 rounded-full bg-sakura/20 flex items-center justify-center"><i class="fa-solid fa-check text-[10px] text-sakura"></i></div> Kimono Set</li>
                        <li class="flex items-center gap-2"><div class="w-5 h-5 rounded-full bg-sakura/20 flex items-center justify-center"><i class="fa-solid fa-check text-[10px] text-sakura"></i></div> Obi & Vision Electro</li>
                        <li class="flex items-center gap-2"><div class="w-5 h-5 rounded-full bg-sakura/20 flex items-center justify-center"><i class="fa-solid fa-check text-[10px] text-sakura"></i></div> Aksesori Rambut</li>
                        <li class="flex items-center gap-2"><div class="w-5 h-5 rounded-full bg-sakura/20 flex items-center justify-center"><i class="fa-solid fa-check text-[10px] text-sakura"></i></div> Stoking & Leg Guard</li>
                ...
                <form action="{{ route('booking.index') }}" method="GET" class="space-y-6 bg-white/40 p-5 md:p-6 rounded-[2rem] border-2 border-dark-chocolate/10">
                    <input type="hidden" name="kostum_id" value="1">
                    <div>
