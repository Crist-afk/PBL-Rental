...
@section('title', 'Sewa Spiderman - CosRent')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-8">
            ...
            <section class="glass-card rounded-[2.5rem] border-2 border-dark-chocolate/10 p-4 shadow-xl flex items-center justify-center">
                <div class="w-full h-[400px] md:h-[500px] bg-dark-chocolate/10 rounded-[2rem] flex flex-col items-center justify-center relative overflow-hidden group">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSdpITVxwRDN82bcorTgLgb7VW0kbodTzzadA&s" alt="Spiderman" class="w-full h-full object-cover transition duration-500 group-hover:scale-105">
                    <div class="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300 pointer-events-none">
                        <span class="text-misty-rose font-bold"><i class="fa-solid fa-image mr-2"></i>Gambar Spiderman</span>
                    </div>
                </div>
            </section>
            ...
            <section class="glass-card rounded-[2.5rem] border-2 border-dark-chocolate/10 p-6 md:p-8 shadow-xl flex flex-col">
                <span class="mb-2 block text-xs font-black uppercase tracking-[0.35em] text-aloewood">Marvel Universe</span>
                <h1 class="text-4xl md:text-5xl font-extrabold text-dark-chocolate mb-2">Spiderman</h1>
                
                <div class="flex flex-wrap items-center gap-4 mb-6 pb-6 border-b border-dark-chocolate/10">
                    <span class="text-3xl font-black text-sakura">Rp 150.000 <span class="text-lg font-medium text-dark-chocolate/60">/ 3 Hari</span></span>
                ...
                <div class="space-y-4 mb-8 flex-grow">
                    ...
                    <p class="text-dark-chocolate/80 text-sm font-medium leading-relaxed">
                        Kostum Spiderman dengan desain klasik merah-biru yang ikonik. Terbuat dari bahan spandeks berkualitas tinggi yang elastis dan mengikuti bentuk tubuh, memberikan kenyamanan maksimal saat bergerak. Topeng dilengkapi dengan lensa jaring-jaring yang jernih untuk penglihatan yang baik.
                    </p>
                    ...
                    <ul class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm font-medium text-dark-chocolate/80">
                        <li class="flex items-center gap-2"><div class="w-5 h-5 rounded-full bg-sakura/20 flex items-center justify-center"><i class="fa-solid fa-check text-[10px] text-sakura"></i></div> Jumpsuit Spandeks</li>
                        <li class="flex items-center gap-2"><div class="w-5 h-5 rounded-full bg-sakura/20 flex items-center justify-center"><i class="fa-solid fa-check text-[10px] text-sakura"></i></div> Topeng (Lensa Jaring)</li>
                        <li class="flex items-center gap-2"><div class="w-5 h-5 rounded-full bg-sakura/20 flex items-center justify-center"><i class="fa-solid fa-check text-[10px] text-sakura"></i></div> Sarung Tangan</li>
                        <li class="flex items-center gap-2"><div class="w-5 h-5 rounded-full bg-sakura/20 flex items-center justify-center"><i class="fa-solid fa-check text-[10px] text-sakura"></i></div> Detail Web-Shooter</li>
                ...
                <form action="{{ route('booking.index') }}" method="GET" class="space-y-6 bg-white/40 p-5 md:p-6 rounded-[2rem] border-2 border-dark-chocolate/10">
                    <input type="hidden" name="kostum_id" value="4">
                    <div>
