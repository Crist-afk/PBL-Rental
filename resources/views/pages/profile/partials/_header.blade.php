    ...
    <div class="relative px-6 pb-8 md:px-10">
                ...
                <div class="relative z-10 inline-block">
                    @if($user->avatar)
                        <img
                            ...
                            alt="Profile photo of {{ $user->nama }}"
                        >
                    @else
        ...
        <div class="mt-4">
            <p class="mb-6 max-w-3xl text-sm font-medium leading-relaxed text-dark-chocolate/80 md:text-base">
                {{ filled($user->bio) ? $user->bio : 'No profile description yet. Click Edit Profile to add a short bio.' }}
            </p>
            ...
            <div class="flex gap-6 border-y border-dark-chocolate/10 py-4">
                <div class="text-center">
                    ...
                    <span class="text-xs font-bold uppercase tracking-wide text-aloewood">Forum Posts</span>
                </div>
                <div class="text-center">
                    <span class="block text-2xl font-bold text-dark-chocolate">{{ $profileStats['rental_count'] }}</span>
                    <span class="text-xs font-bold uppercase tracking-wide text-aloewood">Costumes Rented</span>
                </div>
                <div class="text-center">
                    <span class="block text-2xl font-bold text-dark-chocolate">{{ $profileStats['rating_label'] }}</span>
                    <span class="text-xs font-bold uppercase tracking-wide text-aloewood">Renter Rating</span>
                </div>
            </div>
        </div>
    </div>
